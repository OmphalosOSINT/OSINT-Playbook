...
| OpenStreetMap | Collaborative world map, inspect individual objects (ways, nodes, relations) with tags, history and contributors for infrastructure verification | Carte mondiale collaborative, inspecter les objets individuels (ways, nœuds, relations) avec leurs tags, historique et contributeurs pour la vérification d'infrastructures | Google Maps, Bing Maps | Free | 🌐 International | [openstreetmap.org](https://www.openstreetmap.org) |
...
| MapComplete | Thematic OpenStreetMap viewer and editor, browse and contribute data by topic (cycling, trees, signage, infrastructure...) | Visualiseur et éditeur OpenStreetMap thématique, consulter et contribuer des données par sujet (cyclisme, arbres, panneaux, infrastructures...) | Overpass Turbo, uMap | Free | 🇧🇪 Belgium | [mapcomplete.org](https://mapcomplete.org) |
| Nominatim | OpenStreetMap geocoding and reverse geocoding, convert addresses to coordinates and coordinates to addresses | Géocodage et géocodage inversé OpenStreetMap, convertir des adresses en coordonnées et des coordonnées en adresses | Google Geocoding API, Photon | Free | 🌐 International | [nominatim.org](https://nominatim.org) |
