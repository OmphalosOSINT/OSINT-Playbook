...
| Sentinel Hub | Satellite and multispectral imagery from ESA Sentinel missions — free access | Imagerie satellite et multispectrale des missions ESA Sentinel — accès gratuit | Google Earth Engine | Freemium | 🇸🇮 Slovenia | [sentinel-hub.com](https://www.sentinel-hub.com) |
...
| Jeffrey's Exif Viewer | Online EXIF metadata viewer — no installation required | Visualiseur de métadonnées EXIF en ligne — aucune installation requise | ExifTool | Free | 🇺🇸 USA | [exifdata.com](https://www.exifdata.com) |
