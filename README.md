...
🇬🇧 — All content in this repository complies with applicable law and OSINT ethical standards. Never access private data without authorization, exploit found credentials, or use findings to harass individuals. Always operate within your legal jurisdiction.

🇫🇷 — Tout le contenu de ce repository respecte le cadre légal en vigueur et les principes éthiques de l'OSINT. Ne jamais accéder à des données privées sans autorisation, exploiter des credentials trouvés, ou utiliser les résultats pour harceler des individus. Toujours opérer dans le cadre légal de sa juridiction.
